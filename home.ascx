...
<!-- Wrap all page content here -->
      <!-- Fixed navbar -->
      <div class="navbar navbar-default navbar-fixed topMenu">
      ...
      <!-- Begin page content -->
          <div class="row">
              <div id="TopRightPane" runat="server" class="col-sm-6 col-md-4"></div>
              <div id="TopCenterPane" runat="server" class="col-sm-6 col-md-4"></div>
              <div id="TopLeftPanel" runat="server" class="col-sm-6 col-md-4"></div>
              <div class="clearfix visible-md-block"></div>
              <div id="MiddleRightPane" runat="server" class="col-sm-6 col-md-4"></div>
              <div id="MiddleCenterPane" runat="server" class="col-sm-6 col-md-4"></div>
              <div id="MiddleLeftPanel" runat="server" class="col-sm-6 col-md-4"></div>
          </div>
          <div class="row">
